...
public class CustomerController {
    ...
    // http://localhost:8080/customers/customer/7
    // http://localhost:8080/customers/customer/77
    ...
    // http://localhost:8080/customers/namelike/mes
    // http://localhost:8080/customers/namelike/cin
    ...
    // http://localhost:8080/customers/customer/19
    @PutMapping(value = "/customer/{custcode}", consumes = "application/json", produces = "application/json")
    public ResponseEntity<?> updateFullCustomer(@PathVariable long custcode, @RequestBody Customer updateCustomer)
    {
    ...
    // http://localhost:8080/customers/customer/54
